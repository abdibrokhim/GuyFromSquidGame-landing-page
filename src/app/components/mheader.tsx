    ...
    <>
      <div className="w-full max-w-3xl p-2 flex flex-col justify-between items-center bg-[var(--text-a)] rounded-full border-[2px] border-[var(--bg-a)] top-10 fixed z-30 shadow-lg">
        ...
        {/* <div className="hidden md:flex">
          ...
          <button
            className="flex flex-row items-center text-[var(--text-a)] text-xs md:text-sm bg-[var(--dark-green)] hover:bg-[var(--dark-pink)] shadow-lg rounded-full px-4 py-2 transition-transform hover:scale-110"
            onClick={toggleDropdown}
            aria-label="Open Menu"
        >
            <Image
