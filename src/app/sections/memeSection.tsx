...
export default function MemeSection() {
  ...
  return (
    <div className="w-full relative min-h-screen" id="meme">
      <div className="w-full min-h-screen flex items-center justify-center bg-[url('/images/meme-cover1.png')] bg-cover bg-no-repeat bg-center relative" />
      
      {/* Right-side infinite scrolling container */}
      <div 
        ref={scrollRef}
        className="absolute right-0 top-0 h-full w-1/2 bg-transparent overflow-hidden z-10"
      >
        {/* First set of memes */}
